...
class Index(generic.ListView):
    ...
    template_name = 'modalex/index.html'
...
class BookReadView(BSModalReadView):
    model = Book
    template_name = 'modalex/examples/read_book.html'


class BookDeleteView(BSModalDeleteView):
    model = Book
    template_name = 'modalex/examples/delete_book.html'
...
class SignUpView(BSModalCreateView):
    ...
    template_name = 'modalex/examples/signup.html'
